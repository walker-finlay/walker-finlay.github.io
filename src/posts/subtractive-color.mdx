...
teaser: "Experimenting with color theory via html canvas elements"
...
\begin{align}
  ...
  \\
  \text{CMYK to RGB} &= f : [0, 1] \rightarrow [0, 255] = f(\mathbf{x}) = 255(1-\mathbf{x})(1-k)
  \\
